      ...
      >
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <p className="text-sm text-foreground/80 font-thai">
              สวัสดีครับ ผมนายธีรภัทร ภู่ระย้า ผู้พัฒนาแพลตฟอร์ม ผมอยากที่จะการอนุรักษ์และต้องการเผบแพร่มรดกทางวัฒนธรรมของประเทศไทยผ่านแพลตฟอร์มเชิงโค้ตอบที่ผมสร้างขึ้น
            </p>
          </motion.div>
        </div>
